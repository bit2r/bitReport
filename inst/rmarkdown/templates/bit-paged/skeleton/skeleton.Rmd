...
if (is.null(buttom_txt)) {
  buttom_txt <- "bitReport"
} 
...
.pagedjs_page.pagedjs_named_page.pagedjs_chapter_page.pagedjs_left_page .pagedjs_margin-bottom-right>.pagedjs_margin-content::after {
    content: '", buttom_txt, " / ' var(--pagedjs-string-first-date-text);
}
...
single_line <- air_passengers %>% 
  ...
  geom_line(colour = bit_orange, linewidth = 1) + # Define line chart color to bit_orange
